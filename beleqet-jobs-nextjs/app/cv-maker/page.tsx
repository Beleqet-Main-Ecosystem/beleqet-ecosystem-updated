        ...
        <div className="space-y-5 print:hidden">
          ...
          >
            ...
            <button
              ...
              disabled={extracting}
              className="flex w-full items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-primary/15 bg-pageBg px-5 py-7 text-sm font-bold text-ink transition hover:border-brandGreen hover:bg-brandGreen/5 disabled:cursor-wait disabled:opacity-70"
            >
              {extracting ? (
                <>
