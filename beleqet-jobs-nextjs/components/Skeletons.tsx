export function JobCardSkeleton() {
  return (
    <div className="flex flex-col rounded-xl border border-border bg-surface p-5 animate-pulse">
    ...
    <section className="container-page py-14">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
        {Array.from({ length: 7 }).map((_, i) => (
          <div key={i} className="flex flex-col items-center gap-2 rounded-xl border border-border bg-surface px-3 py-5 animate-pulse">
...
export function JobsListingSkeleton() {
  return (
    <div className="container-page py-10">
      ...
      <div className="h-16 rounded-2xl border border-border bg-surface mt-6 mb-8 animate-pulse" />
  ...
  return (
    <div className="container-page py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
        <div className="rounded-2xl border border-border bg-surface p-7 animate-pulse">
