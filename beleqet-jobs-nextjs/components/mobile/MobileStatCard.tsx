 ...
 * @property formattedValue - Pre-formatted locale-aware string (e.g. "1,234").
 *                         When provided, this takes precedence over `value.toLocaleString()`.
 * @property currencyValue  - Pre-formatted currency string (e.g. "ETB 5,000.00").
 *                         When provided, it replaces the numeric value display entirely.
 */
...
export default function MobileStatCard({
  ...
  /** Display priority: currencyValue > formattedValue > raw value.toLocaleString() */
  const displayValue = currencyValue ?? formattedValue ?? value.toLocaleString();
