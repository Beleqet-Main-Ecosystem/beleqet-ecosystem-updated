  ...
  return (
    <AlertDialog.Root open={open} onOpenChange={onOpenChange}>
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="fixed left-1/2 top-1/2 z-[90] w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-[24px] border border-primary/10 bg-surface p-6 shadow-2xl">
          ...
          <AlertDialog.Title className="mt-4 text-xl font-black text-ink">
            {title}
          </AlertDialog.Title>
          ...
          <div className="mt-6 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
            <AlertDialog.Cancel className="rounded-full border border-primary/15 px-5 py-2.5 text-sm font-bold text-ink hover:bg-pageBg">
              Cancel
            </AlertDialog.Cancel>
            <AlertDialog.Action
              onClick={onConfirm}
