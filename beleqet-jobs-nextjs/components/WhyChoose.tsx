    ...
    <section className="container-page py-20 lg:py-24">
      <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr]">
        <div>
          ...
          <h2 className="max-w-md text-[clamp(2.25rem,4vw,4rem)] font-black leading-[.98] tracking-[-.05em] text-ink">
            Less searching.
            <br />
            More progress.
          </h2>
        ...
        <div className="divide-y divide-border border-y border-border">
          {features.map((feature) => (
            ...
            >
              <span className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-border bg-surface text-brandGreen">
              ...
              <span className="hidden text-4xl font-black text-ink/10 sm:block">
                {feature.number}
              </span>
            </div>
          ))}
