...
RUN apt-get update && apt-get install -y openssl && rm -rf /var/lib/apt/lists/* && chown -R node:node /app
...
# Copy the generated Prisma client (including query engine) from builder stage
