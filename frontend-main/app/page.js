...
export default function Home() {
  useEffect(() => {
    ...
    const testimonials = [
      ...
      {
        q: 'We posted one role and had six qualified direct applications by evening — no recruiter fees, no back-and-forth.',
        n: 'Hiwot M.',
        r: 'HR Lead, hiring on Beleqet',
        tag: 'job',
      },
      {
        q: 'Direct apply meant I skipped the agency entirely. Interview was booked the same week.',
        n: 'Mikiyas G.',
        r: 'Sales Executive, Addis Ababa',
        tag: 'job',
      },
    ];
     ...
     <div className="tibeb-page-bg"></div>
      <header className="nav" id="site-nav">
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          <a className="btn btn-dark" href="#" id="nav-cta">
            Post a Job
          </a>
        </div>
      </header>
        ...
        <section className="hero" style={{ paddingTop: '44px' }}>
          ...
          <div className="board-wrap">
            ...
            <div className="board">
              ...
              <div className="board-foot" id="board-foot-text">
        ...
        <div className="stat-strip">
          <div className="stats reveal" id="stats-row">
            <div className="stat">
              ...
              <div>
                <b data-target="10000" data-suffix="+">
                  0
                </b>
            ...
            <div className="stat">
              ...
              <div>
                <b data-target="5000" data-suffix="+">
                  0
                </b>
            ...
            <div className="stat">
              ...
              <div>
                <b data-target="50000" data-suffix="+">
                  0
                </b>
          ...
          <div className="cat-mini">
            <div className="icon">
              <svg viewBox="0 0 24 24" stroke="currentColor">
                ...
                <path d="M5 21h10a2 2 0 0 0 2-2V7l-4-4H7a2 2 0 0 0-2 2v3" />
                <path d="M2 15h5" />
                <path d="M2 18h5" />
              </svg>
            </div>
      ...
      <section id="why">
        <div className="sec-head reveal" style={{ display: 'block' }}>
          ...
          <p className="sec-p">
            Not a translated template, and not two products stapled together — one account, one
            trust system, for jobs and freelance work alike.
          </p>
        </div>
          ...
          <div className="diffs">
            <div className="diff reveal">
              ...
              <div>
                ...
                <p>
                  See the real number before you apply. No surprises, no negotiation guessing games
            ...
            <div className="diff reveal">
              ...
              <div>
                ...
                <p>
                  Every listing routes straight to the employer's own channel — no recruiter
                  middlemen, no forms that vanish.
                </p>
              </div>
            </div>
            <div className="diff reveal">
              ...
              <div>
                ...
                <p>
                  The matcher learns from real outcomes, not just keyword overlap, so
                  recommendations sharpen the more you use it.
                </p>
              </div>
            </div>
            <div className="diff reveal">
              ...
              <div>
                <h3>Amharic-first, always</h3>
                <p>
                  Designed in Amharic from day one, with English alongside it — not bolted on as an
                  afterthought.
                </p>
              </div>
            </div>
        ...
        <div className="why-group">
          ...
          <div className="diffs">
            <div className="diff reveal">
              <span className="num">01</span>
              <div>
                <h3>Escrow-protected payments</h3>
                <p>
                  Funds sit safely in BeleqetSafe until you approve the work, with a 14-day
                  auto-approval so nothing stalls forever.
                </p>
              </div>
            </div>
            <div className="diff reveal">
              <span className="num">02</span>
              <div>
                <h3>Local payment rails</h3>
                <p>
                  Get paid the way you already do business — through Chapa or Telebirr, no
                  international wallet required.
                </p>
              </div>
            </div>
            <div className="diff reveal">
              <span className="num">03</span>
              <div>
                <h3>Verified freelancer profiles</h3>
                <p>
                  Portfolios and ratings tied to real delivered work, not just a profile photo and a
                  claim.
                </p>
              </div>
            </div>
            <div className="diff reveal">
              ...
              <div>
                <h3>No agency cut</h3>
                <p>
                  You deal directly with the client or freelancer — Beleqet's fee is disclosed
                  upfront, nothing hidden later.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="testimonials">
        <div className="sec-head reveal" style={{ display: 'block' }}>
          ...
          <p className="sec-p">
            Real roles and real projects, job seekers, freelancers, and the people hiring them — in
            their own words.
          </p>
        </div>
        <div className="marquee-outer reveal">
        ...
        <section id="community" style={{ padding: 0 }}>
          <div className="cta-band reveal">
            ...
            <div className="cta-buttons">
              ...
              <a className="btn btn-outline-hero" href="#categories">
                Browse Jobs &amp; Gigs
              </a>
            </div>
          </div>
        ...
        <div className="foot-inner">
          <div className="foot-top">
            <div className="foot-brand">
              ...
              <p>
                Beleqet helps job seekers and freelancers discover opportunities, and employers and
                clients connect with the right talent across Ethiopia.
              </p>
            </div>
            <div className="foot-cols">
              ...
              <div className="foot-col">
                ...
                <a href="#freelance-categories">Browse Gigs</a>
                <a href="#">Post a Project</a>
                <a href="#">BeleqetSafe Escrow</a>
