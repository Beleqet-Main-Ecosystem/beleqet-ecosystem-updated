...
/**
 * Hook managing FAQ Bot session, WebSocket streaming, and REST fallbacks.
 */
export function useFaqBotStream(locale: Locale, currency: Currency) {
  ...
  /** Initialize GDPR-compliant session after user consent. */
  ...
  /** Send a user question and receive streamed assistant response. */
