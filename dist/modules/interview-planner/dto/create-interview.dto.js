...
class CreateInterviewDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { applicationId: { required: true, type: () => String }, startTime: { required: true, type: () => String }, endTime: { required: true, type: () => String }, timezone: { required: false, type: () => String }, notes: { required: false, type: () => String } };
    }
}
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateInterviewDto.prototype, "timezone", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
