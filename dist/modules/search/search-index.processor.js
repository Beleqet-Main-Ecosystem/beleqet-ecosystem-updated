...
let SearchIndexProcessor = SearchIndexProcessor_1 = class SearchIndexProcessor extends bullmq_1.WorkerHost {
    constructor(prisma) {
        super();
        this.prisma = prisma;
...
exports.SearchIndexProcessor = SearchIndexProcessor = SearchIndexProcessor_1 = __decorate([
    ...
    (0, bullmq_1.Processor)(queues_constants_1.QUEUE_NAMES.SEARCH_INDEX),
