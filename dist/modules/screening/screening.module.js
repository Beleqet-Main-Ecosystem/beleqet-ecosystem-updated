...
exports.ScreeningModule = ScreeningModule = __decorate([
    (0, common_1.Module)({
        imports: [
            bullmq_1.BullModule.registerQueue({ name: queues_constants_1.QUEUE_NAMES.APPLICATION }, { name: queues_constants_1.QUEUE_NAMES.NOTIFICATIONS }, { name: queues_constants_1.QUEUE_NAMES.ANALYTICS }),
        ],
