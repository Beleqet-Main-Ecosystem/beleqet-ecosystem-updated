...
class CreateDisputeDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { contractId: { required: true, type: () => String }, reason: { required: true, type: () => String }, evidenceUrls: { required: true, type: () => [String] } };
    }
}
...
], CreateDisputeDto.prototype, "contractId", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
