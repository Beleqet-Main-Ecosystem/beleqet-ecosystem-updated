export declare const QUEUE_NAMES: {
    ...
    readonly JOB_ALERTS: "job-alerts";
    readonly VIDEO_INTERVIEW: "video-interview";
};
export declare const REFERRAL_JOBS: {
    readonly PROCESS_REFERRAL: "process-referral";
    readonly AWARD_BONUS: "award-referral-bonus";
    readonly EXPIRE_LINKS: "expire-referral-links";
};
export declare const JOB_ALERT_JOBS: {
    readonly DISPATCH_ALERTS: "dispatch-job-alerts";
    readonly SEND_DIGEST: "send-alert-digest";
};
...
export declare const VIDEO_INTERVIEW_JOBS: {
    readonly TRANSCRIBE: "transcribe-video-response";
    readonly EVALUATE: "evaluate-interview";
    readonly CLEANUP_EXPIRED: "cleanup-expired-interviews";
    readonly NOTIFY_COMPLETE: "notify-interview-complete";
};
