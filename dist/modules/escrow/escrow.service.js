...
let EscrowService = EscrowService_1 = class EscrowService {
    constructor(prisma, config, walletSvc, escrowQueue, eventEmitter) {
        this.prisma = prisma;
        this.config = config;
    ...
    async initiate(clientId, freelanceJobId) {
        ...
        if (walletAppliedAmount > 0 && amountToPay > 0) {
            await this.escrowQueue.add(queues_constants_1.ESCROW_JOBS.UNLOCK_FUNDS, {
                escrowId: escrow.id,
                clientId,
...
exports.EscrowService = EscrowService = EscrowService_1 = __decorate([
    ...
    __param(3, (0, bullmq_1.InjectQueue)(queues_constants_1.QUEUE_NAMES.ESCROW)),
