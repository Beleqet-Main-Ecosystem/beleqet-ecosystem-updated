...
import { AI_CHAT_PROVIDER } from '../resume-brain/ai/ai-chat-provider.interface';
import { GroqProvider } from '../resume-brain/ai/groq.provider';

@Module({
  controllers: [SmartSkillTesterController],
  providers: [SmartSkillTesterService, { provide: AI_CHAT_PROVIDER, useClass: GroqProvider }],
